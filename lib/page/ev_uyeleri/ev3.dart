...
class ev3 extends StatefulWidget {
  const ev3({Key? key}) : super(key: key);

  @override
  State<ev3> createState() => _ev3State();
}

class _ev3State extends State<ev3> {
  @override
  Widget build(BuildContext context) {
    String isim1 = "Mert Tanrıverdi";
    int ev1alacak = 75;
    int ev2alacak = 17;
              ...
              Padding(
                ...
                child: Center(
                  child: ClipRRect(
                    ...
                    child: const Image(
                      image: AssetImage("assets/plate3.jpg"),
                      fit: BoxFit.cover,
                      height: 150,
                      width: 150,
                    ),
